...
class _MyAppState extends State<MyApp> {
  ...
  final _flutterKotlinxSerializationVersionMismatchBugPlugin =
      FlutterKotlinxSerializationVersionMismatchBug();
  ...
  Future<void> initPlatformState() async {
    ...
    try {
      platformVersion =
          await _flutterKotlinxSerializationVersionMismatchBugPlugin
                  .getPlatformVersion() ??
